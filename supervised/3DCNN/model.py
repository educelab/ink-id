...
def buildModel(x, y, args):
    ...
    conv2 = slim.batch_norm(slim.convolution(conv1, 2*args["layer1_neurons"], args["receptiveField"], stride=[2,2,1]))
    ...
    net = tf.nn.dropout(slim.fully_connected(slim.flatten(conv3), args["n_Classes"], activation_fn=None), args["dropout"])
