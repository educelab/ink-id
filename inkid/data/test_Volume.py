...
class VectorMathTestCase(unittest.TestCase):
    ...
    def test_get_component_vectors_from_normal(self):
        ...
        self.assertEqual(
            ...
            {
                "x": {
                    "x": 0.7298901677131653,
                    "y": -0.24309885501861572,
                    "z": -0.6388766169548035,
                },
                "y": {
                    "x": -0.24309885501861572,
                    "y": 0.7812110185623169,
                    "z": -0.5749889612197876,
                },
                "z": {
                    "x": 0.6388766169548035,
                    "y": 0.5749889612197876,
                    "z": 0.5111011862754822,
                },
            },
        )
